package net.neverendlesspvp.cratekeys.inventory.item;
...
public class MeInventoryItem {
    ...
    public MeInventoryItem addLore(String lore) {
        ItemMeta itemMeta = itemStack.getItemMeta();
        List<String> loreStringList = (itemMeta.hasLore()) ? itemMeta.getLore() : new ArrayList<>();
